...
export default function About() {
  const contactLinks = [
    {
      ...
      icon: <CiMail className="size-6 text-white hover:text-neutral-200" />,
    },
    {
      href: "https://www.linkedin.com/in/anthonyych4n/",
      icon: <CiLinkedin className="size-6 text-white hover:text-neutral-200" />,
    },
    {
      href: "https://github.com/anthonyych4n",
      icon: (
        <IoLogoGithub className="size-6 text-white hover:text-neutral-200" />
      ),
    },
    {
      href: "resume2025summer.pdf",
      icon: <IoIosPaper className="size-6 text-white hover:text-neutral-200" />,
  ...
  return (
    <div className="text-white max-w-sm space-y-5">
      ...
      <a href="/more-about-me" className="underline">
        More about me
      </a>
